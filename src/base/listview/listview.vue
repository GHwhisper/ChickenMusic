...
<script>
    ...
    export default {
        ...
        created() {
            ...
            this.listHeight = []    // 记录每个group的高度位置
            this.probeType = 3
        },
        computed: {
            shortcutList() {
        ...
        methods: {
            ...
            onShortcutTouchMove(e) {
                ...
                let delta = (this.touch.y2 - this.touch.y1) / ANCHOR_HEIGHT | 0    // " | 0 "向下取整，同Math.floor
            ...
            _scrollTo(index) {
                ...
                this.scrollY = -this.listHeight[index]  // 经测试，不加这句，无论是点击还是touchmove都能正确滚动到相应位置
